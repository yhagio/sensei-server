...
import SetSequelize from './infra/sequelize/db';
...
const db = new SetSequelize(appConfig);
...
const usersReader = new UsersReader(new UsersReaderStore(models));
const usersWriter = new UsersWriter(new UsersWriterStore(models));
// const relationshipsWriter = new RelationshipsWriter(
//   new RelationshipsWriterStore(models)
// );
// const coursesReader = new CoursesReader(new CoursesReaderStore(models));
// const coursesWriter = new CoursesWriter(new CoursesWriterStore(models));
